    ...
    <div className="min-h-screen bg-virel-dark flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 mt-1">Entre na sua conta VIREL</p>
        </div>

        <div className="bg-virel-dark-card border border-virel-dark-border rounded-2xl p-6">
          <Button variant="secondary" size="lg" className="w-full mb-6" type="button">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="#" className="text-virel-purple-400 text-sm hover:underline">
                Esqueci minha senha
              </Link>
            </div>
        ...
        <p className="text-center text-white/50 text-sm mt-6">
          Não tem conta?{" "}
          <Link href={`/${locale}/register`} className="text-virel-purple-400 hover:underline font-medium">
            Criar conta grátis
          </Link>
        </p>
      </div>
